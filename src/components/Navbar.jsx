...
const Navbar = () => {
    ...
    return (
        <header ref={navigation} className=" flex flex-wrap sm:justify-between sm:flex-nowrap w-full  text-sm py-3 navbar fixed top-0 z-50 bg-gray-50  px-0 lg:px-0 xl:px-5 2xl:px-36">
            <nav className=" w-full  sm:flex sm:items-center sm:justify-between">
                ...
                <div id="hs-navbar-example" ref={hsNav} className="hidden transition-max-height duration-300 ease-in-out overflow-hidden sm:max-h-none sm:block ${isOpen ? 'max-h-40 opacity-100' : 'max-h-0 opacity-0'} bg-gray-50 lg:bg-transparent p-5 w-full" aria-labelledby="hs-navbar-example-collapse">
                    <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5 w-full">
